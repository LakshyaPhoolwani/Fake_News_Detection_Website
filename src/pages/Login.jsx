      ...
      >
        <div className="max-w-md w-full mx-auto px-4">
          <motion.div
            ...
            className="bg-gray-800/50 backdrop-blur-md border border-gray-700 rounded-2xl p-8 shadow-2xl text-center"
          >
            ...
            <p className="text-gray-300 mb-6">You are currently signed in as:</p>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-[1.02]"
              >
              ...
              <button
                ...
                className="w-full bg-gray-600 hover:bg-gray-500 text-white py-3 rounded-xl font-medium transition-all duration-300"
              >
                Sign Out
              </button>
            </div>
